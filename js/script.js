...
async function fetchAPIData(endpoint) {
    const API_KEY = '3672298430a23e5e03b12e1a7a0e39da';
...
// show the spinner when we're loading data from the api
function showSpinner() {
    document.querySelector('.spinner').classList.add('show')
}

// hide the spinner when we're not loading data from the api
